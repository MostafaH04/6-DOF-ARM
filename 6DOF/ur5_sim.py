...
while p.isConnected():
	...
	#set torques
	max_force = 500
	curr_pos = positions[i%len(positions)]
	for iter in range(0,actuated_joints_num):		
		p.setJointMotorControl2(robotID, iter+1, p.POSITION_CONTROL, targetPosition = curr_pos[iter], targetVelocity = 900, force=max_force)
